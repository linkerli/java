...
const imgList = [
  ...
  require("../assets/images/18_img.jpg"),
  require("../assets/images/19_img.jpg"),
  require("../assets/images/20_img.jpg"),
  require("../assets/images/21_img.jpg"),
];
...
export default {
  ...
  data: () => {
    return {
      currentIndex: 0,
      lastImg: require("../assets/images/21_img.jpg"),
      height: getHeight()
    };
  },
  watch: {
