...
public class ContextConfig {
    ...
    private String proPackage = "com.cola.magazine.admin";
    private String coreBasePackage = "com.cola.magazine.core";
    private String modelPackageName = "com.cola.magazine.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.cola.magazine.modular.system.dao";    //model的dao
