package com.cola.magazine.generator.engine.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        //imports.add("com.baomidou.mybatisplus.com.stylefeng.guns.rest.persistence.service.impl.ServiceImpl");
        ...
        //interfaceImports.add("com.baomidou.mybatisplus.com.stylefeng.guns.rest.persistence.service.IService");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\impl\\{}ServiceImpl.java";
