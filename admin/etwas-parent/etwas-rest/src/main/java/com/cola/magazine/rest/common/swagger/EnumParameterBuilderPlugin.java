...
public class EnumParameterBuilderPlugin implements ParameterBuilderPlugin, OperationBuilderPlugin {
    ...
    public void apply(ParameterContext context) {
        ...
        if (Enum.class.isAssignableFrom(type)) {
            SwaggerZowmDisplayEnum annotation = AnnotationUtils.findAnnotation(type, SwaggerZowmDisplayEnum.class);
            if (annotation != null) {
                ...
                parameterBuilder.allowableValues(values).parameterType("Intger");
            }
        }
    }
    ...
    public void apply(OperationContext context) {
        ...
        parameters.forEach(parameter -> {
            ...
            if (Enum.class.isAssignableFrom(clazz)) {
                SwaggerZowmDisplayEnum annotation = AnnotationUtils.findAnnotation(clazz, SwaggerZowmDisplayEnum.class);
                if (annotation != null) {
                    String index = annotation.index();
                    String name = annotation.name();
