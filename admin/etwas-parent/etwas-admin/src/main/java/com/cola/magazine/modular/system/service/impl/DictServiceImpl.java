...
import com.cola.magazine.core.common.constant.factory.MutiStrFactory;
import com.cola.magazine.core.common.exception.BizExceptionEnum;
import com.cola.magazine.core.exception.EtwasException;
import com.cola.magazine.modular.system.dao.DictMapper;
import com.cola.magazine.modular.system.model.Dict;
import com.cola.magazine.modular.system.service.IDictService;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictCode,String dictName,String dictTips, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new EtwasException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new EtwasException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
