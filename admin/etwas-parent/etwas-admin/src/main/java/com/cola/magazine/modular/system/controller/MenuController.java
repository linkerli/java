...
import com.cola.magazine.core.common.constant.dictmap.MenuDict;
...
import com.cola.magazine.core.support.BeanKit;
import com.cola.magazine.core.util.ToolUtil;
import com.cola.magazine.modular.system.model.Menu;
import com.cola.magazine.modular.system.service.IMenuService;
import com.cola.magazine.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new EtwasException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new EtwasException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
