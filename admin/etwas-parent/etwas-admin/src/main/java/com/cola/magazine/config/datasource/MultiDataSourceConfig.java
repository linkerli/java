package com.cola.magazine.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.cola.magazine.core.config.properties.DruidProperties;
import com.cola.magazine.core.config.properties.MutiDataSourceProperties;
import com.cola.magazine.core.datascope.DataScopeInterceptor;
import com.cola.magazine.core.mutidatasource.DynamicDataSource;
import com.cola.magazine.core.mutidatasource.aop.MultiSourceExAop;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "magazine.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.cola.magazine.modular.*.dao","com.cola.magazine.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "magazine.muti-datasource")
