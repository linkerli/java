package com.cola.magazine.modular.code.factory;


import com.cola.magazine.EtwasApplication;
import com.cola.magazine.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static List<Map<String,Object>> getDefaultTemplates(){
        ...
        templates.add(create("serviceSwitch","com.cola.magazine.rest.persistence.service-service模板"));
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("cola");
        genQo.setProjectPackage(EtwasApplication.class.getPackage().getName());
